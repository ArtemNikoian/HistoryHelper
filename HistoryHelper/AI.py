...
if sys.version_info[0] == 2:
    try:
        subprocess.run(["pip", "install", "openai", "openpyxl", "datetime"])
    except subprocess.CalledProcessError as error:
        print("Error installing libraries in Python 2:", error)
else:
    try:
        subprocess.run(["pip3", "install", "openai", "openpyxl", "datetime"])
    except subprocess.CalledProcessError as error:
        print("Error installing libraries in Python 3:", error)
