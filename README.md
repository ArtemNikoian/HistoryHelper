...
Remember that the file structure should be as in BaseFile, otherwise the code will work improperly. Do not forget to delete all empty columns when you delete information about any event.
